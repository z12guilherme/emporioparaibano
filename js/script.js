...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const produtos = {
    temperos: [
      ...
      { name: 'Cominho Moído (100g)', desc: 'Especiaria versátil para carnes, legumes, ovos, feijão, lentilha, arroz, batatas e sopas.', price: 5.00, img: 'img/temperos/cominho_moido.jpg' },
      ...
      { name: 'Bacon Desidratado (100g)', desc: 'Sabor defumado autêntico, ótimo em feijão, sopas, farofas e hambúrgueres.', price: 6.00, img: 'img/temperos/bacon_desidratado.jpg' },
      { name: 'Pimenta do Reino Preta em Grãos (100g)', desc: 'Grãos inteiros com aroma intenso, ideal para moer na hora.', price: 10.00, img: 'img/temperos/pimenta_do_reino_graos.jpg' },
      { name: 'Pimenta do Reino Preta Moída (100g)', desc: 'Versátil, dá toque picante e marcante em carnes, molhos e sopas.', price: 10.00, img: 'img/temperos/pimenta_do_reino_preta_moida.jpg' },
      ...
      { name: 'Alho Frito Granulado (100g)', desc: 'Adiciona crocância e sabor em pratos, ótimo para finalizar receitas.', price: 5.50, img: 'img/temperos/alho_frito_granulado.jpg' },
      ...
      { name: 'Tempero Beef Ribs (100g)', desc: 'Ideal para preparar carnes bovinas, suínas, assados, e refogados, ele também adiciona um sabor excepcional em hambúrgueres, ovos e muitos outros pratos.', price: 6.00, img: 'img/temperos/beef.jpg' },
      ...
      { name: 'Cebola desidratada (100g)', desc: 'A cebola desidratada é um tempero amplamente utilizado na culinária para adicionar sabor e aroma a pratos salgados. Ela é produzida a partir de cebolas frescas que passam por um processo de desidratação para remover a água e concentrar os seus sabores e nutrientes.', price: 5.50, img: 'img/temperos/cebola_desidratada.jpg' },
    ...
    chas: [
      ...
      { name: 'Capim-Limão (50g)', desc: 'O Capim-santo, também conhecido como capim-limão ou capim-cidreira, é uma planta medicinal com propriedades calmantes, digestivas, antioxidantes e antimicrobianas.', price: 4.50, img: 'img/chas/capim_limao.jpg' },
      ...
      { name: 'Carqueja (50g)', desc: 'A carqueja é muito utilizada para auxiliar em problemas de digestão e do fígado, como azia e gastrite, além de atuar como diurético, ajudando a reduzir a retenção de líquidos.', price: 4.00, img: 'img/chas/carqueja.jpg' },
      ...
      { name: 'Chá Verde (50g)', desc: 'O chá verde oferece uma variedade de benefícios para a saúde, como sua ação antioxidante, que combate o envelhecimento precoce, ele também pode ajudar no processo de emagrecimento ao acelerar o metabolismo.', price: 3.50, img: 'img/chas/cha_verde.jpg' },
      ...
      { name: 'Hibisco (50g)', desc: 'O Chá de Hibisco, pode oferecer vários benefícios para a saúde, incluindo a melhora da saúde cardiovascular, ajudando a controlar a pressão arterial e o colesterol.', price: 4.00, img: 'img/chas/hibisco.jpg' },
      ...
      { name: 'Louro Folhas (30g)', desc: 'A folha de louro serve para melhorar a digestão, aliviar dores musculares e cólicas, combater o estresse, reduzir a retenção de líquidos e ajudar no controle do colesterol e da diabetes.', price: 3.00, img: 'img/chas/cha_louro.jpg' },
    ...
    funcionais: [
      ...
      { name: 'Catuaba em Pó (100g)', desc: 'A Catuaba em pó serve como um energizante natural e afrodisíaco, ajudando a aumentar a energia física e mental, combater o cansaço, a fadiga e o estresse, melhorar a memória, a circulação sanguínea e a função sexual. Também possui propriedades antioxidantes e anti-inflamatórias, sendo utilizada para aumentar a vitalidade e o bem-estar geral.', price: 5.00, img: 'img/funcionais/catuaba_em_po.jpg' },
      { name: 'Colágeno em Pó Hidrolisado (100g)', desc: 'O Colágeno em pó Hidrolisado serve para fortalecer a pele, unhas e cabelos, prevenir a flacidez e melhorar a saúde das articulações e ossos, o que é especialmente útil com o envelhecimento, quando o corpo produz menos colágeno. Ele também ajuda na recuperação muscular e desempenho físico, além de complementar a dieta e as estruturas do corpo como tendões e cartilagens.', price: 13.00, img: 'img/funcionais/colageno.jpg' },
      ...
      { name: 'Marapuama em Pó (100g)', desc: 'A marapuama em pó é usada como auxiliar natural para a saúde sexual e libido, com propriedades estimulantes do sistema nervoso central, além de benefícios contra fadiga, estresse, depressão e problemas de memória. Também é utilizada como tônico para circulação e disposição física.', price: 5.00, img: 'img/funcionais/marapuama.jpg' },
    ...
    diversos: [
      ...
      { name: 'Porta-Condimentos Preto Giratório c/09 potes', desc: 'O Porta-Temperos é super funcional, prático, tem um formato ergonômico e moderno, podendo armazenar todos seus condimentos de forma correta e em um mesmo local.', price: 60.00, img: 'img/diversos/porta_preto_9.jpg' },
      { name: 'Porta-Condimentos Preto Giratório c/12 potes', desc: 'O Porta-Temperos é super funcional, prático, tem um formato ergonômico e moderno, podendo armazenar todos seus condimentos de forma correta e em um mesmo local.', price: 70.00, img: 'img/diversos/porta_preto12.jpg' },
      { name: 'Porta-Condimentos Artesanal c/08 potes', desc: 'Mantenha seus temperos e especiarias bem conservados, com esse maravilhoso Porta-condimentos. Com acabamento feito a mão, este organizador é uma escolha artesanal que o transforma em uma peça de destaque que agrega charme com um toque rústico à sua cozinha.', price: 75.00, img: 'img/diversos/porta_artesanal.jpg' },
      ...
      { name: 'Vinagre Orgânico de Maçã Almaromi (400ml)', desc: 'O Vinagre de Maçã Almaromi é 100% natural e produzido para atender os mais exigentes paladares. Possui acidez de 4%, embalagem especial e é apresentado em garrafa pet de 400 ml.', price: 25.00, img: 'img/diversos/vinagre_maca.jpg' }
    ]
  };
  ...
  produtos.oleaginosas = [
    ...
    { name: 'Castanha Frita com Sal (100g)', price: 10.00, desc: 'Pode ser consumida em lanches ou aperitivos, mas com moderação, devido à adição de gorduras e sal.', img: 'img/oleaginosas/castanha_frita_com_sal.jpg' },
    { name: 'Castanha de Caju Tradicional (100g)', price: 10.00, desc: 'Beneficia o coração, fortalece o sistema imunológico e a saúde óssea. Pode melhorar o humor e a memória graças ao triptofano e magnésio.', img: 'img/oleaginosas/castanha_de_caju_tradicional.jpg' },
    { name: 'Castanha Caramelizada (100g)', price: 9.00, desc: 'Snack crocante e nutritivo, feito com açúcar mascavo e gergelim. Combina o sabor da castanha com a crocância do gergelim.', img: 'img/oleaginosas/castanha_caramelizada.jpg' },
    { name: 'Castanha do Pará (100g)', price: 14.00, desc: 'Beneficia a saúde cardiovascular, cerebral e imunológica devido ao seu alto teor de selênio. Recomenda-se um consumo moderado (2 a 3 unidades por dia).', img: 'img/oleaginosas/castanha_do_para.jpg' },
    { name: 'Nozes Mariposa (100g)', price: 10.00, desc: 'Oferecem múltiplos benefícios à saúde, como a proteção cardiovascular e ação antioxidante devido à presença de ômega-3, vitaminas e minerais.', img: 'img/oleaginosas/nozes_mariposa.jpg' }
  ];
