...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const produtos = {
    ...
    sementesEgraos: [
      { name: 'Chia (100g)', desc: 'A chia serve para promover a saciedade e auxiliar na perda de peso, por ser rica em fibras, além de controlar o nível de açúcar no sangue e melhorar a saúde intestinal. Também contribui para a saúde cardiovascular devido ao seu teor de ômega-3, fortalece ossos e dentes por ser fonte de cálcio e minerais, e pode até aumentar a imunidade. A semente pode ser consumida em iogurtes, saladas, sucos ou hidratada em água.', price: 4.50, img: 'img/placeholder.jpg' },
      { name: 'Gergelim Branco (100g)', desc: 'O Gergelim Branco serve como um superalimento rico em nutrientes, fornecendo proteínas, gorduras saudáveis, fibras, cálcio, magnésio e outros minerais que contribuem para a saúde óssea e o bom funcionamento do organismo. Além disso, auxilia na melhora do colesterol e da digestão, e suas propriedades antioxidantes e o teor de fitoestrogênios podem beneficiar a saúde da pele, aliviar sintomas da menopausa e regular hormônios da tireoide.', price: 4.80, img: 'img/placeholder.jpg' },
      { name: 'Gergelim Preto (100g)', desc: 'Assim como o Gergelim Branco, o Gergelim Preto serve para a saúde devido ao seu alto teor de nutrientes, como cálcio, ferro, fibras e antioxidantes, sendo útil para a saúde óssea, digestiva e do coração, além de possuir propriedades anti-inflamatórias e poder ser usado como ingrediente em diversos pratos culinários, incluindo pães, saladas e pastas.', price: 4.80, img: 'img/placeholder.jpg' },
      { name: 'Granola Diet a granel (100g)', desc: 'A granola diet é uma combinação nutricional benéfica que fornece energia, ajuda na saciedade devido às fibras e carboidratos, melhora a saúde digestiva, e fornece vitaminas, minerais e gorduras saudáveis essenciais para o bom funcionamento do organismo e para a vitalidade diária, a versão diet, é ideal para dieta com restrições de açúcares,pois não altera os índices glicêmicos.', price: 3.00, img: 'img/placeholder.jpg' },
      { name: 'Granola Tradicional a granel (100g)', desc: 'A granola Tradicional é uma combinação nutricional benéfica que fornece energia, ajuda na saciedade devido às fibras e carboidratos, melhora a saúde digestiva, e fornece vitaminas, minerais e gorduras saudáveis essenciais para o bom funcionamento do organismo e para a vitalidade diária.', price: 3.00, img: 'img/placeholder.jpg' },
      { name: 'Granola Banana a granel (100g)', desc: 'A granola com banana é uma combinação nutricional benéfica que fornece energia, ajuda na saciedade devido às fibras e carboidratos, melhora a saúde digestiva, e fornece vitaminas, minerais e gorduras saudáveis essenciais para o bom funcionamento do organismo e para a vitalidade diária,com um toque especial, sabor banana.', price: 3.00, img: 'img/placeholder.jpg' },
      { name: 'Granola Sabor da Terra 250g (Sabor Banana)', desc: 'Granola Sabor da Terra 250g (Sabor Banana)', price: 6.99, img: 'img/placeholder.jpg' },
      { name: 'Granola Sabor da Terra 250g (Sabor Cacau 70%)', desc: 'Granola Sabor da Terra 250g (Sabor Cacau 70%)', price: 6.99, img: 'img/placeholder.jpg' },
      { name: 'Granola Sabor da Terra 250g (Sabor Tradicional)', desc: 'Granola Sabor da Terra 250g (Sabor Tradicional)', price: 6.99, img: 'img/placeholder.jpg' },
      { name: 'Granola Salgada (100g)', desc: 'Para quem deseja uma alimentação equilibrada e com menos açúcar, a Granola Salgada é uma excelente escolha. Com baixo teor de carboidratos, ela é uma aliada perfeita para manter a dieta em dia sem abrir mão do sabor. Além disso, seus ingredientes incluem propriedades antioxidantes, anti-inflamatórias e termogênicas, que potencializam seus benefícios à saúde.', price: 3.00, img: 'img/placeholder.jpg' },
      { name: 'Grão-de-Bico (100g)', desc: 'O Grão-de-bico é uma leguminosa rica em proteínas vegetais, fibras, vitaminas e minerais, conhecida pela sua versatilidade culinária e benefícios para a saúde, como o auxílio à digestão e ao humor. Pode ser consumido de diversas formas, incluindo em saladas, pastas, sopas, guisados, e até em farinha para pães e bolos.', price: 4.00, img: 'img/placeholder.jpg' },
      { name: 'Lentilha (100g)', desc: 'A Lentilha oferece inúmeros benefícios, como melhorar a saúde do coração (controlando pressão e colesterol), auxiliar na prevenção e tratamento da anemia, ajudar no controle da diabetes e do peso, por ser rica em fibras e ter baixo índice glicêmico. Também contribui para a saúde óssea e o sistema imunológico, e é uma ótima fonte de proteína vegetal, ideal para vegetarianos e veganos.', price: 3.00, img: 'img/placeholder.jpg' },
      { name: 'Linhaça Dourada (100g)', desc: 'A linhaça dourada oferece benefícios como a melhora da saúde intestinal e do controle do peso, devido ao seu alto teor de fibras. É também uma fonte de ômega 3, que auxilia na redução do colesterol e na prevenção de doenças cardiovasculares. Além disso, a linhaça dourada tem propriedades antioxidantes e anti-inflamatórias que fortalecem o sistema imunológico e auxiliam na saúde da pele e cabelo.', price: 4.00, img: 'img/placeholder.jpg' },
      { name: 'Linhaça Marrom (100g)', desc: 'A Linhaça Marrom oferece benefícios como a melhora da saúde intestinal e do coração, ajuda no controle de peso e da glicemia, e possui propriedades antioxidantes e anti-inflamatórias devido ao seu alto teor de fibras, ômega 3 e lignanas, também contribui para a saúde da pele e pode aliviar sintomas da TPM e menopausa. É recomendável consumir a linhaça moída para melhor absorção dos nutrientes.', price: 4.00, img: 'img/placeholder.jpg' },
      { name: 'Mix de Quinoa em grãos (100g)', desc: 'O Mix de Quinoa oferece vários benefícios, como alto teor de proteínas e fibras, que auxiliam na digestão, saciedade e controle do peso; é uma fonte de vitaminas (complexo B, A, C, E) e minerais (ferro, cálcio, magnésio, zinco), importantes para ossos, músculos e o sistema imunológico, e contém antioxidantes, ômega 3 e 6 que protegem contra o envelhecimento precoce e doenças cardiovasculares. Por ser sem glúten, é uma ótima opção para celíacos e intolerantes.', price: 5.00, img: 'img/placeholder.jpg' },
      { name: 'Pepita de Girassol (100g)', desc: 'As pepitas de girassol (ou sementes de girassol sem casca), oferecem múltiplos benefícios à saúde, incluindo a melhoria da saúde cardiovascular devido ao seu teor de gorduras saudáveis e fibras, a proteção da pele e cabelos devido às vitaminas e antioxidantes, o fortalecimento dos ossos e músculos por serem ricas em minerais, o auxílio na regulação do colesterol, a potencial melhoria do sistema imunológico e o auxílio na gestão do peso e controle da diabetes.', price: 5.00, img: 'img/placeholder.jpg' },
      { name: 'Semente de Abóbora (100g)', desc: 'As Sementes de Abóbora oferecem múltiplos benefícios à saúde devido ao seu conteúdo de magnésio, zinco, fibras, antioxidantes e proteínas, incluindo a melhoria da saúde cardiovascular, o controle do açúcar no sangue, o reforço do sistema imunológico, a promoção da qualidade do sono e o auxílio à digestão e saciedade. Elas também podem contribuir para a saúde da próstata e ajudar a aumentar a massa muscular.', price: 7.00, img: 'img/placeholder.jpg' },
      { name: 'Semente de Girassol - com casca (100g)', desc: 'A Semente de Girassol com Casca pode ser consumida de diversas formas: Como lanche entre as refeições, basta quebrar a casca com os dentes e consumir a semente interna. Adicionada a mixes de sementes e oleaginosas, para um snack nutritivo, torrada com um pouco de sal ou temperos naturais. Pode também ser usada para alimentar aves ornamentais ou animais de estimação, sob orientação adequada.', price: 2.50, img: 'img/placeholder.jpg' },
      { name: 'Soja em Grãos (100g)', desc: 'A Soja em Grãos é um superalimento que oferece múltiplos benefícios à saúde, como a redução do colesterol LDL, a prevenção de doenças cardiovasculares, a melhora do funcionamento intestinal e o auxílio na perda de peso devido à sua alta quantidade de fibras e proteínas. Além disso, é rica em minerais como cálcio e magnésio, importantes para a saúde óssea, e isoflavonas, que aliviam os sintomas da menopausa.', price: 3.50, img: 'img/placeholder.jpg' }
    ]
  };
  ...
  function renderProdutos() {
    ['temperos','chas','funcionais','sementesEgraos'].forEach(cat => {
