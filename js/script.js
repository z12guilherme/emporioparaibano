...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const produtos = {
    ...
    sementesEgraos: [
      ...
      { name: 'Gergelim Branco (100g)', desc: 'O Gergelim Branco serve como um superalimento rico em nutrientes, fornecendo proteínas, gorduras saudáveis, fibras, cálcio, magnésio e outros minerais que contribuem para a saúde óssea e o bom funcionamento do organismo. Além disso, auxilia na melhora do colesterol e da digestão, e suas propriedades antioxidantes e o teor de fitoestrogênios podem beneficiar a saúde da pele, aliviar sintomas da menopausa e regular hormônios da tireoide.', price: 4.80, img: 'img/sementeseGraos/gergelim.jpg' },
      { name: 'Gergelim Preto (100g)', desc: 'Assim como o Gergelim Branco, o Gergelim Preto serve para a saúde devido ao seu alto teor de nutrientes, como cálcio, ferro, fibras e antioxidantes, sendo útil para a saúde óssea, digestiva e do coração, além de possuir propriedades anti-inflamatórias e poder ser usado como ingrediente em diversos pratos culinários, incluindo pães, saladas e pastas.', price: 4.80, img: 'img/sementeseGraos/gergelimpreto.jpg' },
